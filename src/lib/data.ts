...
// Fallback mock data for client-side rendering and build time
...
const fallbackAuditors: Auditor[] = [
  {
    id: 'AUD001',
    name: 'Jane Doe',
    avatarUrl: 'https://picsum.photos/seed/user1/100/100',
...
function getFallbackData() {
  return {
    ...
    users: fallbackUsers,
    auditors: fallbackAuditors,
    agents: fallbackAgents,
    evidence: fallbackEvidence,
    auditLogs: fallbackAuditLogs,
    courses: [] as Course[],
    customerCourses: [] as CustomerCourse[],
    dashboardStats: {
...
// Export fallback data for build time and client-side usage
export const mockProjects = fallbackProjects;
export const mockUsers = fallbackUsers;
export const mockAuditors = fallbackAuditors;
export const mockAgents = fallbackAgents;
export const mockEvidence = fallbackEvidence;
export const mockAuditLogs = fallbackAuditLogs;
